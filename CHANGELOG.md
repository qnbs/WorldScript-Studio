...
- **Playwright (CI):** Removed flaky visual baseline `export-preview.png` from export E2E (text assertion retained); import persistence reload navigates to Dashboard and asserts `#projectTitle` via `toHaveValue`.
