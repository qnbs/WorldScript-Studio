...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7299%2B_%2F_591_files-22C55E" alt="7299+ tests / 591 files">
...
| **Testing**          | Vitest 4.x (7299+ tests / 591 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (7299+ tests, 591 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **7299+ unit tests** across **591 test files** — CI is authoritative for pass/fail
