...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7047%2B_%2F_579_files-22C55E" alt="7047+ tests / 579 files">
...
| **Testing**          | Vitest 4.x (7047+ tests / 579 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (7047+ tests, 579 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **7047+ unit tests** across **579 test files** — CI is authoritative for pass/fail
