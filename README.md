...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7646%2B_%2F_604_files-22C55E" alt="7646+ tests / 604 files">
...
| **Testing**          | Vitest 4.x (7646+ tests / 604 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (7646+ tests, 604 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **7646+ unit tests** across **604 test files** — CI is authoritative for pass/fail
