...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7926%2B_%2F_609_files-22C55E" alt="7926+ tests / 609 files">
...
| Testing | Vitest 4.x (7926+ tests / 609 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (7926+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **7926+ unit tests** across **609 test files**
