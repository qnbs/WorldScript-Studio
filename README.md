...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-6911%2B_%2F_568_files-22C55E" alt="6911+ tests / 568 files">
...
| **Testing**          | Vitest 4.x (6911+ tests / 568 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (6911+ tests, 568 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **6911+ unit tests** across **568 test files** — CI is authoritative for pass/fail
