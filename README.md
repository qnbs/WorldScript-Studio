...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7499%2B_%2F_601_files-22C55E" alt="7499+ tests / 601 files">
...
| **Testing**          | Vitest 4.x (7499+ tests / 601 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (7499+ tests, 601 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **7499+ unit tests** across **601 test files** — CI is authoritative for pass/fail
