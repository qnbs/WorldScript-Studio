...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8143%2B_%2F_617_files-22C55E" alt="8143+ tests / 617 files">
...
| Testing | Vitest 5.x (8143+ tests / 617 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (8143+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **8143+ unit tests** across **617 test files**
