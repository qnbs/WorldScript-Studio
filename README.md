...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8006%2B_%2F_612_files-22C55E" alt="8006+ tests / 612 files">
...
| Testing | Vitest 4.x (8006+ tests / 612 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (8006+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **8006+ unit tests** across **612 test files**
