...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-6867%2B_%2F_564_files-22C55E" alt="6867+ tests / 564 files">
...
| **Testing**          | Vitest 4.x (6867+ tests / 564 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (6867+ tests, 564 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **6867+ unit tests** across **564 test files** — all passing
