...
| **Testing**          | Vitest 4.x (7754+ tests / 606 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (7754+ tests, 606 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **7754+ unit tests** across **606 test files** — CI is authoritative for pass/fail
