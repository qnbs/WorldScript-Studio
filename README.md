...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8412%2B_%2F_625_files-22C55E" alt="8412+ tests / 625 files">
...
| Testing | Vitest 5.x (8412+ tests / 625 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (the 8412+ total also includes components/ and packages/*/tests; tests/e2e is excluded)
│   └── e2e/                 # Playwright
...
- **8412+ unit tests** across **625 test files**
