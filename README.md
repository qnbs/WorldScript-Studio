...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8099%2B_%2F_616_files-22C55E" alt="8099+ tests / 616 files">
...
| Testing | Vitest 4.x (8099+ tests / 616 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (8099+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **8099+ unit tests** across **616 test files**
