...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-6934%2B_%2F_572_files-22C55E" alt="6934+ tests / 572 files">
...
| **Testing**          | Vitest 4.x (6934+ tests / 572 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (6934+ tests, 572 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **6934+ unit tests** across **572 test files** — CI is authoritative for pass/fail
