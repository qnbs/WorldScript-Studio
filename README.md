...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8071%2B_%2F_615_files-22C55E" alt="8071+ tests / 615 files">
...
| Testing | Vitest 4.x (8071+ tests / 615 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (8071+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **8071+ unit tests** across **615 test files**
