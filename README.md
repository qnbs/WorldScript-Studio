...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7852%2B_%2F_608_files-22C55E" alt="7852+ tests / 608 files">
...
| Testing | Vitest 4.x (7852+ tests / 608 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (7852+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **7852+ unit tests** across **608 test files**
