...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8306%2B_%2F_621_files-22C55E" alt="8306+ tests / 621 files">
...
| Testing | Vitest 5.x (8306+ tests / 621 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (the 8306+ total also includes components/ and packages/*/tests; tests/e2e is excluded)
│   └── e2e/                 # Playwright
...
- **8306+ unit tests** across **621 test files**
