...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8447%2B_%2F_628_files-22C55E" alt="8447+ tests / 628 files">
...
| Testing | Vitest 5.x (8447+ tests / 628 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (the 8447+ total also includes components/ and packages/*/tests; tests/e2e is excluded)
│   └── e2e/                 # Playwright
...
- **8447+ unit tests** across **628 test files**
