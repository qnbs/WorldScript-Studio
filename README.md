...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8058%2B_%2F_614_files-22C55E" alt="8058+ tests / 614 files">
...
| Testing | Vitest 4.x (8058+ tests / 614 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (8058+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **8058+ unit tests** across **614 test files**
