...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7498%2B_%2F_601_files-22C55E" alt="7498+ tests / 601 files">
...
| **Testing**          | Vitest 4.x (7498+ tests / 601 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (7498+ tests, 601 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **7498+ unit tests** across **601 test files** — CI is authoritative for pass/fail
