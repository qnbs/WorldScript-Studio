...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8102%2B_%2F_616_files-22C55E" alt="8102+ tests / 616 files">
...
├── tests/
│   ├── unit/                # Vitest unit tests (8102+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **8102+ unit tests** across **616 test files**
