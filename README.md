...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8356%2B_%2F_623_files-22C55E" alt="8356+ tests / 623 files">
...
| Testing | Vitest 5.x (8356+ tests / 623 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (the 8356+ total also includes components/ and packages/*/tests; tests/e2e is excluded)
│   └── e2e/                 # Playwright
...
- **8356+ unit tests** across **623 test files**
