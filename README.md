...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8271%2B_%2F_620_files-22C55E" alt="8271+ tests / 620 files">
...
| Testing | Vitest 5.x (8271+ tests / 620 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (the 8271+ total also includes components/ and packages/*/tests; tests/e2e is excluded)
│   └── e2e/                 # Playwright
...
- **8271+ unit tests** across **620 test files**
