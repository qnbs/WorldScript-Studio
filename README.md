...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-6927%2B_%2F_570_files-22C55E" alt="6927+ tests / 570 files">
...
Shipped UI locales with **2924 i18n keys** across all 19 languages — zero hardcoded user-facing strings:
...
| **Testing**          | Vitest 4.x (6927+ tests / 570 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (6927+ tests, 570 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **6927+ unit tests** across **569 test files** — CI is authoritative for pass/fail
