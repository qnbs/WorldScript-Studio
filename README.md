...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-6944%2B_%2F_574_files-22C55E" alt="6944+ tests / 574 files">
...
| **Testing**          | Vitest 4.x (6944+ tests / 574 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (6944+ tests, 574 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **6944+ unit tests** across **574 test files** — CI is authoritative for pass/fail
