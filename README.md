...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8015%2B_%2F_612_files-22C55E" alt="8015+ tests / 612 files">
...
| Testing | Vitest 4.x (8015+ tests / 612 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (8015+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **8015+ unit tests** across **612 test files**
