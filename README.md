...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7032%2B_%2F_579_files-22C55E" alt="7032+ tests / 579 files">
...
| **Testing**          | Vitest 4.x (7032+ tests / 579 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (7032+ tests, 579 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **7032+ unit tests** across **579 test files** — CI is authoritative for pass/fail
