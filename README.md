...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8063%2B_%2F_614_files-22C55E" alt="8063+ tests / 614 files">
...
| Testing | Vitest 4.x (8063+ tests / 614 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (8063+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **8063+ unit tests** across **614 test files**
