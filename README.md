...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/i18n-19_locales-2903_keys-0EA5E9" alt="i18n 19 locales — 2903 keys">
...
Shipped UI locales with **2903 i18n keys** across all 19 languages — zero hardcoded user-facing strings:
...
| **i18n**             | Custom React Context (`I18nContext.tsx`)                  | 2903 keys × 19 locales (de/en/es/fr/it + ar/he/fa RTL Beta + ja/zh/pt/el/fi/sv/hu/is/eu/ru/ko Beta); EN fallback; `localStorage` persistence |
...
- i18n: **2903 keys × 19 locales** (en/de/fr/es/it + ar/he/fa RTL Beta + ja/zh/pt/el/fi/sv/hu/is/eu Beta)
