...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7375%2B_%2F_597_files-22C55E" alt="7375+ tests / 597 files">
...
| **Testing**          | Vitest 4.x (7375+ tests / 597 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (7375+ tests, 597 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **7375+ unit tests** across **597 test files** — CI is authoritative for pass/fail
