...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8335%2B_%2F_623_files-22C55E" alt="8335+ tests / 623 files">
...
| Testing | Vitest 5.x (8335+ tests / 623 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (the 8335+ total also includes components/ and packages/*/tests; tests/e2e is excluded)
│   └── e2e/                 # Playwright
...
- **8335+ unit tests** across **623 test files**
