...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7359%2B_%2F_595_files-22C55E" alt="7359+ tests / 595 files">
...
| **Testing**          | Vitest 4.x (7359+ tests / 595 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (7359+ tests, 595 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **7359+ unit tests** across **595 test files** — CI is authoritative for pass/fail
