...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-6965%2B_%2F_577_files-22C55E" alt="6965+ tests / 577 files">
...
| **Testing**          | Vitest 4.x (6965+ tests / 577 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (6965+ tests, 577 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **6965+ unit tests** across **577 test files** — CI is authoritative for pass/fail
