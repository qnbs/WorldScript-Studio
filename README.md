...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8365%2B_%2F_624_files-22C55E" alt="8365+ tests / 624 files">
...
| Testing | Vitest 5.x (8365+ tests / 624 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (the 8365+ total also includes components/ and packages/*/tests; tests/e2e is excluded)
│   └── e2e/                 # Playwright
...
- **8365+ unit tests** across **624 test files**
