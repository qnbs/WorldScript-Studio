...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7719%2B_%2F_606_files-22C55E" alt="7719+ tests / 606 files">
...
| **Testing**          | Vitest 4.x (7719+ tests / 606 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (7719+ tests, 606 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **7719+ unit tests** across **606 test files** — CI is authoritative for pass/fail
