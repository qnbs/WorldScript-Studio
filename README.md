...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7507%2B_%2F_602_files-22C55E" alt="7507+ tests / 602 files">
...
| **Testing**          | Vitest 4.x (7507+ tests / 602 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (7507+ tests, 602 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **7507+ unit tests** across **602 test files** — CI is authoritative for pass/fail
