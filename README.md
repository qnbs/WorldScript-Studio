...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7957%2B_%2F_610_files-22C55E" alt="7957+ tests / 610 files">
...
| Testing | Vitest 4.x (7957+ tests / 610 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (7957+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **7957+ unit tests** across **610 test files**
