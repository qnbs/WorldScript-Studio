...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8423%2B_%2F_626_files-22C55E" alt="8423+ tests / 626 files">
...
| Testing | Vitest 5.x (8423+ tests / 626 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (the 8423+ total also includes components/ and packages/*/tests; tests/e2e is excluded)
│   └── e2e/                 # Playwright
...
- **8423+ unit tests** across **626 test files**
