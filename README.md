...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Release-v1.28.7-6366F1" alt="Release v1.28.7">
  ...
  <img src="https://img.shields.io/badge/Tests-8119%2B_%2F_616_files-22C55E" alt="8119+ tests / 616 files">
...
| Testing | Vitest 5.x (8119+ tests / 616 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (8119+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **8119+ unit tests** across **616 test files**
