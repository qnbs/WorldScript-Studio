...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7837%2B_%2F_608_files-22C55E" alt="7837+ tests / 608 files">
...
| Testing | Vitest 4.x (7837+ tests / 608 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (7837+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **7837+ unit tests** across **608 test files**
