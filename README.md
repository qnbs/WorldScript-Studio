...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7472%2B_%2F_599_files-22C55E" alt="7472+ tests / 599 files">
...
| **Testing**          | Vitest 4.x (7472+ tests / 599 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (7472+ tests, 599 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **7472+ unit tests** across **599 test files** — CI is authoritative for pass/fail
