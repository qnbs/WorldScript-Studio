...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7850%2B_%2F_608_files-22C55E" alt="7850+ tests / 608 files">
...
| Testing | Vitest 4.x (7850+ tests / 608 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (7850+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **7850+ unit tests** across **608 test files**
