...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-6959%2B_%2F_576_files-22C55E" alt="6959+ tests / 576 files">
...
| **Testing**          | Vitest 4.x (6959+ tests / 576 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (6959+ tests, 576 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **6959+ unit tests** across **576 test files** — CI is authoritative for pass/fail
