...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8077%2B_%2F_615_files-22C55E" alt="8077+ tests / 615 files">
...
| Testing | Vitest 4.x (8077+ tests / 615 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (8077+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **8077+ unit tests** across **615 test files**
