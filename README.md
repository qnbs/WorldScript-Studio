...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7958%2B_%2F_610_files-22C55E" alt="7958+ tests / 610 files">
...
| Testing | Vitest 4.x (7958+ tests / 610 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (7958+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **7958+ unit tests** across **610 test files**
