...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/i18n-19_locales-2923_keys-0EA5E9" alt="i18n 19 locales — 2923 keys">
  <img src="https://img.shields.io/badge/Tests-6870%2B_%2F_564_files-22C55E" alt="6870+ tests / 564 files">
...
Shipped UI locales with **2923 i18n keys** across all 19 languages — zero hardcoded user-facing strings:
...
| **i18n**             | Custom React Context (`I18nContext.tsx`)                  | 2923 keys × 19 locales (de/en/es/fr/it + ar/he/fa RTL Beta + ja/zh/pt/el/fi/sv/hu/is/eu/ru/ko Beta); EN fallback; `localStorage` persistence |
| **Testing**          | Vitest 4.x (6870+ tests / 564 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (6870+ tests, 564 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **6870+ unit tests** across **564 test files** — all passing
- Coverage thresholds: lines ≥ 80 · branches ≥ 66 · functions ≥ 72 · statements ≥ 78 — enforced in CI (see Codecov badge for live metrics)
- i18n: **2923 keys × 19 locales** (en/de/fr/es/it + ar/he/fa RTL Beta + ja/zh/pt/el/fi/sv/hu/is/eu/ru/ko Beta)
