...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7526%2B_%2F_602_files-22C55E" alt="7526+ tests / 602 files">
...
| **PWA**              | Service Worker + Web App Manifest v3                     | Offline support, installability, Workbox chunking                    |
 ...
 | **Testing**          | Vitest 4.x (7526+ tests / 602 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (7526+ tests, 602 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **7526+ unit tests** across **602 test files** — CI is authoritative for pass/fail
