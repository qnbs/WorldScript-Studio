...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7169%2B_%2F_588_files-22C55E" alt="7169+ tests / 588 files">
...
| **Testing**          | Vitest 4.x (7169+ tests / 588 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (7169+ tests, 588 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **7169+ unit tests** across **588 test files** — CI is authoritative for pass/fail
