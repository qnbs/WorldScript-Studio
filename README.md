...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8398%2B_%2F_624_files-22C55E" alt="8398+ tests / 624 files">
...
| Testing | Vitest 5.x (8398+ tests / 624 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (the 8398+ total also includes components/ and packages/*/tests; tests/e2e is excluded)
│   └── e2e/                 # Playwright
...
- **8398+ unit tests** across **624 test files**
