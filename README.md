...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-6905%2B_%2F_567_files-22C55E" alt="6905+ tests / 567 files">
...
| **Testing**          | Vitest 4.x (6905+ tests / 567 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (6905+ tests, 567 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **6905+ unit tests** across **567 test files** — all passing
