...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7829%2B_%2F_607_files-22C55E" alt="7829+ tests / 607 files">
...
| Testing | Vitest 4.x (7829+ tests / 607 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (7829+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **7829+ unit tests** across **607 test files**
