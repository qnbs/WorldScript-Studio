...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-6884%2B_%2F_565_files-22C55E" alt="6884+ tests / 565 files">
...
| **Testing**          | Vitest 4.x (6884+ tests / 565 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (6884+ tests, 565 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **6884+ unit tests** across **565 test files** — all passing
