...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7986%2B_%2F_611_files-22C55E" alt="7986+ tests / 611 files">
...
| Testing | Vitest 4.x (7986+ tests / 611 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (7986+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **7986+ unit tests** across **611 test files**
