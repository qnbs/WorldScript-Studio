...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7828%2B_%2F_607_files-22C55E" alt="7828+ tests / 607 files">
...
| Testing | Vitest 4.x (7828+ tests / 607 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (7828+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **7828+ unit tests** across **607 test files**
