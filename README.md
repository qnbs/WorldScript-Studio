...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-6962%2B_%2F_577_files-22C55E" alt="6962+ tests / 577 files">
...
Shipped UI locales with **2925 i18n keys** across all 19 languages — zero hardcoded user-facing strings:
...
| **Testing**          | Vitest 4.x (6962+ tests / 577 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (6962+ tests, 577 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **6962+ unit tests** across **577 test files** — CI is authoritative for pass/fail
