...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8002%2B_%2F_612_files-22C55E" alt="8002+ tests / 612 files">
...
| Testing | Vitest 4.x (8002+ tests / 612 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (8002+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **8002+ unit tests** across **612 test files**
