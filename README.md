...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8213%2B_%2F_619_files-22C55E" alt="8213+ tests / 619 files">
...
| Testing | Vitest 5.x (8213+ tests / 619 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (the 8213+ total also includes components/ and packages/*/tests; tests/e2e is excluded)
│   └── e2e/                 # Playwright
...
- **8213+ unit tests** across **619 test files**
