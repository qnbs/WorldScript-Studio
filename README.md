...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8434%2B_%2F_627_files-22C55E" alt="8434+ tests / 627 files">
...
| Testing | Vitest 5.x (8434+ tests / 627 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (the 8434+ total also includes components/ and packages/*/tests; tests/e2e is excluded)
│   └── e2e/                 # Playwright
...
- **8434+ unit tests** across **627 test files**
