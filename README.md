...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8173%2B_%2F_618_files-22C55E" alt="8173+ tests / 618 files">
...
| Testing | Vitest 5.x (8173+ tests / 618 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (8173+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **8173+ unit tests** across **618 test files**
