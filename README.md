...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8039%2B_%2F_613_files-22C55E" alt="8039+ tests / 613 files">
...
| Testing | Vitest 4.x (8039+ tests / 613 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (8039+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **8039+ unit tests** across **613 test files**
