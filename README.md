...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/i18n-19_locales-2908_keys-0EA5E9" alt="i18n 19 locales — 2908 keys">
...
Shipped UI locales with **2908 i18n keys** across all 19 languages — zero hardcoded user-facing strings:
...
| **i18n**             | Custom React Context (`I18nContext.tsx`)                  | 2908 keys × 19 locales (de/en/es/fr/it + ar/he/fa RTL Beta + ja/zh/pt/el/fi/sv/hu/is/eu/ru/ko Beta); EN fallback; `localStorage` persistence |
...
- i18n: **2908 keys × 19 locales** (en/de/fr/es/it + ar/he/fa RTL Beta + ja/zh/pt/el/fi/sv/hu/is/eu/ru/ko Beta)
