...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7979%2B_%2F_611_files-22C55E" alt="7979+ tests / 611 files">
...
| Testing | Vitest 4.x (7979+ tests / 611 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (7979+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **7979+ unit tests** across **611 test files**
