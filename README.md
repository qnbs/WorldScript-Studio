...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8103%2B_%2F_616_files-22C55E" alt="8103+ tests / 616 files">
...
| Testing | Vitest 5.x (8103+ tests / 616 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (8103+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **8103+ unit tests** across **616 test files**
