...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8182%2B_%2F_618_files-22C55E" alt="8182+ tests / 618 files">
...
| Testing | Vitest 5.x (8182+ tests / 618 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (the 8182+ total also includes components/ and packages/*/tests; tests/e2e is excluded)
│   └── e2e/                 # Playwright
...
- **8182+ unit tests** across **618 test files**
