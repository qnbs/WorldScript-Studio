...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7370%2B_%2F_596_files-22C55E" alt="7370+ tests / 596 files">
...
| **Testing**          | Vitest 4.x (7370+ tests / 596 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (7370+ tests, 596 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **7370+ unit tests** across **596 test files** — CI is authoritative for pass/fail
