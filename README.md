...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7814%2B_%2F_607_files-22C55E" alt="7814+ tests / 607 files">
...
| Testing | Vitest 4.x (7814+ tests / 607 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (7814+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **7814+ unit tests** across **607 test files**
