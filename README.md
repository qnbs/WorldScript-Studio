...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7896%2B_%2F_609_files-22C55E" alt="7896+ tests / 609 files">
...
| Testing | Vitest 4.x (7896+ tests / 609 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (7896+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **7896+ unit tests** across **609 test files**
