...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8067%2B_%2F_614_files-22C55E" alt="8067+ tests / 614 files">
...
| Testing | Vitest 4.x (8067+ tests / 614 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (8067+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **8067+ unit tests** across **614 test files**
