...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7217%2B_%2F_589_files-22C55E" alt="7217+ tests / 589 files">
...
| **Testing**          | Vitest 4.x (7217+ tests / 589 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (7217+ tests, 589 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **7217+ unit tests** across **589 test files** — CI is authoritative for pass/fail
