...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-7800%2B_%2F_606_files-22C55E" alt="7800+ tests / 606 files">
...
| Testing | Vitest 4.x (7800+ tests / 606 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (7800+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **7800+ unit tests** across **606 test files**
