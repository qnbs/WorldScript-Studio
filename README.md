...
| **Testing**          | Vitest 4.x (6928+ tests / 571 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (6928+ tests, 571 files) — count spans tests/, components/, packages/*/tests/, not just this folder
