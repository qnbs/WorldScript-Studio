...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8021%2B_%2F_612_files-22C55E" alt="8021+ tests / 612 files">
...
| Testing | Vitest 4.x (8021+ tests / 612 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (8021+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **8021+ unit tests** across **612 test files**
