...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-8034%2B_%2F_613_files-22C55E" alt="8034+ tests / 613 files">
...
| Testing | Vitest 4.x (8034+ tests / 613 files) + Playwright | Unit/integration/E2E |
...
├── tests/
│   ├── unit/                # Vitest unit tests (8034+ tests; file count includes package test directories)
│   └── e2e/                 # Playwright
...
- **8034+ unit tests** across **613 test files**
