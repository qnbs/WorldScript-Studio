...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/i18n-19_locales-2918_keys-0EA5E9" alt="i18n 19 locales — 2918 keys">
  <img src="https://img.shields.io/badge/Tests-6477%2B_%2F_547_files-22C55E" alt="6477+ tests / 547 files">
...
Shipped UI locales with **2918 i18n keys** across all 19 languages — zero hardcoded user-facing strings:
...
| **i18n**             | Custom React Context (`I18nContext.tsx`)                  | 2918 keys × 19 locales (de/en/es/fr/it + ar/he/fa RTL Beta + ja/zh/pt/el/fi/sv/hu/is/eu/ru/ko Beta); EN fallback; `localStorage` persistence |
| **Testing**          | Vitest 4.x (6477+ tests / 547 files) + Playwright E2E     | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (6477+ tests, 547 files) — count spans tests/, components/, packages/*/tests/, not just this folder
...
- **6477+ unit tests** across **547 test files** — all passing
- Coverage thresholds: lines ≥ 74 · branches ≥ 60 · functions ≥ 67 · statements ≥ 72 — enforced in CI (see Codecov badge for live metrics)
- i18n: **2918 keys × 19 locales** (en/de/fr/es/it + ar/he/fa RTL Beta + ja/zh/pt/el/fi/sv/hu/is/eu/ru/ko Beta)
