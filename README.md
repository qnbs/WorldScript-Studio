...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/i18n-19_locales-2810_keys-0EA5E9" alt="i18n 19 locales — 2810 keys">
  <img src="https://img.shields.io/badge/Tests-5807%2B_%2F_512_files-22C55E" alt="5807+ tests / 512 files">
...
Shipped UI locales with **2810 i18n keys** across all 19 languages — zero hardcoded user-facing strings:
...
| **i18n**             | Custom React Context (`I18nContext.tsx`)                  | 2810 keys × 19 locales (de/en/es/fr/it + ar/he/fa RTL Beta + ja/zh/pt/el/fi/sv/hu/is/eu Beta); EN fallback; `localStorage` persistence |
| **Testing**          | Vitest 4.x (5807+ tests / 512 files) + Playwright E2E    | Unit/integration + cross-browser E2E; Stryker mutation (manual workflow)          |
...
├── tests/
│   ├── unit/             # Vitest unit tests (5807+ tests, 512 files)
...
- **5807+ unit tests** across **512 test files** — all passing
- Coverage thresholds: lines ≥ 74 · branches ≥ 60 · functions ≥ 67 · statements ≥ 72 — enforced in CI (see Codecov badge for live metrics)
- i18n: **2810 keys × 19 locales** (en/de/fr/es/it + ar/he/fa RTL Beta + ja/zh/pt/el/fi/sv/hu/is/eu Beta)
