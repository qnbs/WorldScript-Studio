...
- 🔄 **P1-2** — Whisper WASM STT end-to-end: **Download UI ✅ (v1.21, 2026-06-09)** — `VoiceModelDownloadModal` + separate STT/TTS buttons + AbortController cancel shipped. Remaining: VAD → Inference → Transcript pipeline integration (7–10 Tage)
