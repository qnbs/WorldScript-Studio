...
- ✅ **WorkerBus authoritative scheduler hotfix** (2026-08-01) — completed tasks drain from the live queue; dispatch honors priority/FIFO and pool capacity; pool waits are event-driven; queue wait is covered by the progress-rearmed inactivity watchdog; critical work has a hard eight-task reserve.
