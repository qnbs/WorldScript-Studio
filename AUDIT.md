...
**Current version:** **v1.24.3** — released 2026-07-30 (PRs #286–291 merged, tagged `v1.24.3`) — DuckDB analytics, local embeddings, and local NLP migrated onto the shared WorkerBus v2 pool (ADR-0015), closing the v1/v2 worker-generation duplication; recovered a merge queue interrupted mid-session by a local editor crash. **2849 keys × 19 locales**; **6477 tests × 529 files** (2026-07-30, CI-reported).
