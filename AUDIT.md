...
**Current version:** **v1.28.0 release candidate** — tag pending the dedicated release merge; includes the post-v1.27.1 diagnostics, Core-boundary, CI/Stryker-plumbing, and release-truth work. **2923 keys × 19 locales**. Historical release sections below remain historical.
