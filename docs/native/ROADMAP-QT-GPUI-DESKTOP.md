...
```text
[x] new ADR (ADR-0021) supersedes CEF production strategy
[x] CEF PR/issue reconciled: PR #404 closed unmerged, Issue #405 closed as superseded
[x] no useful renderer-neutral work lost — DesktopPlatform boundary unaffected,
    UI-DOMAIN-STATE-CLASSIFICATION.md relocated
[x] CEF-only CI removed (cef-learning-harness.yml was already advisory-only)
[x] CEF-only dependencies no longer required by product build
[x] Tauri remains functional during transition
[x] Qt/GPUI roadmap adopted (this document)
```
...
**Status: COMPLETE.** ADR-0021 adopted; PR #404 closed unmerged; Issue #405 closed as superseded;
`apps/desktop-cef/`, `scripts/cef/`, `.github/workflows/cef-learning-harness.yml`, and 14 of 15
`docs/cef/` files removed (git history is the archive, see `docs/historical/cef/README.md`);
`docs/cef/UI-DOMAIN-STATE-CLASSIFICATION.md` relocated to `docs/native/`; this roadmap adopted; `main`
CI green throughout.
...
1. CEF strategy retirement. **(ADR-0021, complete)**
2. Qt-first native strategy. **(ADR-0021, complete)**
...
**Status: Wave 0 (items 1–7 below) is complete.**
...
3. Extract only renderer-neutral improvements.                               [DONE]
4. Close/supersede CEF-specific PRs with a clear historical note.            [DONE — #404 closed]
5. Adopt new ADR + this roadmap.                                             [DONE — ADR-0021]
6. Rename/generalize CEF-only governance docs where their content remains
   useful.                                                                   [DONE — UI-DOMAIN-STATE-CLASSIFICATION.md]
7. Re-run main CI.                                                           [DONE]
